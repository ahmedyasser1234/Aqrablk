      ...
      <section className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16 min-h-[60vh]">
        ...
        <div className="w-full lg:w-1/2">
          <ScrollReveal delay={0.3}>
            <img 
              src={language === 'ar' ? 'https://res.cloudinary.com/dk3wwuy5d/image/upload/v1768686522/Asset_4_2x_vu9c2h.png' : 'https://res.cloudinary.com/dk3wwuy5d/image/upload/v1768686522/Asset_4_2x_vu9c2h.png'} 
      ...
      <section className="py-12 max-w-7xl mx-auto mt-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <ScrollReveal delay={0.1}>
            ...
            >
              <div className="relative z-10 h-full p-10 rounded-[2rem] bg-[#080911]/80 backdrop-blur-sm flex flex-col justify-center text-center md:text-start">
